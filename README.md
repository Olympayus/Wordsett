...
![version](https://img.shields.io/badge/version-0.5.2-4A6FA5)
...
### 📚 分层字段
**22 个内置字段**（音标、词性、中文/英文释义、例句、词形变化、近义词、派生词、短语、补充、近义词辨析…）支持树形层级与拖拽排序，一个词性下可挂多条释义，释义下还可挂例句与近义词。
...
| 系统 | 安装包 |
|------|--------|
| **Windows** | `Wordsett_0.5.2_x64-setup.exe`（当前发布提供；MSI 暂未随包） |
| **macOS** | `Wordsett_0.5.2_x64.dmg`（在 macOS 上构建） |
| **Linux** | `Wordsett_0.5.2_x86_64.AppImage` / `.deb`（在 Linux 上构建；暂未提供） |
